...
local Cache = require('minx.kit.App.Cache')

---@alias minx.kit.App.Config.SchemaInternal minx.kit.App.Config.Schema|{ revision: integer }

---@class minx.kit.App.Config
---@field private _cache minx.kit.App.Cache
---@field private _default minx.kit.App.Config.SchemaInternal
---@field private _global minx.kit.App.Config.SchemaInternal
---@field private _filetype table<string, minx.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, minx.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default? minx.kit.App.Config.Schema
...
---@param config minx.kit.App.Config.Schema
...
---@return minx.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: minx.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: minx.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: minx.kit.App.Config.Schema) }
