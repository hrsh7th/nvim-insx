local LSP = require('minx.kit.LSP')
local AsyncTask = require('minx.kit.Async.AsyncTask')

---@class minx.kit.LSP.Client
...
---@param params minx.kit.LSP.ImplementationParams
...
---@param params minx.kit.LSP.TypeDefinitionParams
...
---@class minx.kit.LSP.IntersectionType01 : minx.kit.LSP.ConfigurationParams, minx.kit.LSP.PartialResultParams

---@param params minx.kit.LSP.IntersectionType01
...
---@param params minx.kit.LSP.DocumentColorParams
...
---@param params minx.kit.LSP.ColorPresentationParams
...
---@param params minx.kit.LSP.FoldingRangeParams
...
---@param params minx.kit.LSP.DeclarationParams
...
---@param params minx.kit.LSP.SelectionRangeParams
...
---@param params minx.kit.LSP.WorkDoneProgressCreateParams
...
---@param params minx.kit.LSP.CallHierarchyPrepareParams
...
---@param params minx.kit.LSP.CallHierarchyIncomingCallsParams
...
---@param params minx.kit.LSP.CallHierarchyOutgoingCallsParams
...
---@param params minx.kit.LSP.SemanticTokensParams
...
---@param params minx.kit.LSP.SemanticTokensDeltaParams
...
---@param params minx.kit.LSP.SemanticTokensRangeParams
...
---@param params minx.kit.LSP.ShowDocumentParams
...
---@param params minx.kit.LSP.LinkedEditingRangeParams
...
---@param params minx.kit.LSP.CreateFilesParams
...
---@param params minx.kit.LSP.RenameFilesParams
...
---@param params minx.kit.LSP.DeleteFilesParams
...
---@param params minx.kit.LSP.MonikerParams
...
---@param params minx.kit.LSP.TypeHierarchyPrepareParams
...
---@param params minx.kit.LSP.TypeHierarchySupertypesParams
...
---@param params minx.kit.LSP.TypeHierarchySubtypesParams
...
---@param params minx.kit.LSP.InlineValueParams
...
---@param params minx.kit.LSP.InlayHintParams
...
---@param params minx.kit.LSP.InlayHint
...
---@param params minx.kit.LSP.DocumentDiagnosticParams
...
---@param params minx.kit.LSP.WorkspaceDiagnosticParams
...
---@param params minx.kit.LSP.RegistrationParams
...
---@param params minx.kit.LSP.UnregistrationParams
...
---@param params minx.kit.LSP.InitializeParams
...
---@param params minx.kit.LSP.ShowMessageRequestParams
...
---@param params minx.kit.LSP.WillSaveTextDocumentParams
...
---@param params minx.kit.LSP.CompletionParams
...
---@param params minx.kit.LSP.CompletionItem
...
---@param params minx.kit.LSP.HoverParams
...
---@param params minx.kit.LSP.SignatureHelpParams
...
---@param params minx.kit.LSP.DefinitionParams
...
---@param params minx.kit.LSP.ReferenceParams
...
---@param params minx.kit.LSP.DocumentHighlightParams
...
---@param params minx.kit.LSP.DocumentSymbolParams
...
---@param params minx.kit.LSP.CodeActionParams
...
---@param params minx.kit.LSP.CodeAction
...
---@param params minx.kit.LSP.WorkspaceSymbolParams
...
---@param params minx.kit.LSP.WorkspaceSymbol
...
---@param params minx.kit.LSP.CodeLensParams
...
---@param params minx.kit.LSP.CodeLens
...
---@param params minx.kit.LSP.DocumentLinkParams
...
---@param params minx.kit.LSP.DocumentLink
...
---@param params minx.kit.LSP.DocumentFormattingParams
...
---@param params minx.kit.LSP.DocumentRangeFormattingParams
...
---@param params minx.kit.LSP.DocumentOnTypeFormattingParams
...
---@param params minx.kit.LSP.RenameParams
...
---@param params minx.kit.LSP.PrepareRenameParams
...
---@param params minx.kit.LSP.ExecuteCommandParams
...
---@param params minx.kit.LSP.ApplyWorkspaceEditParams
