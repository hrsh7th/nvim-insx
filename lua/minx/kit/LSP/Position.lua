...
---@param encoding? minx.kit.LSP.PositionEncodingKind
...
---@param text string
---@param position minx.kit.LSP.Position
---@param from_encoding minx.kit.LSP.PositionEncodingKind
---@param to_encoding minx.kit.LSP.PositionEncodingKind
