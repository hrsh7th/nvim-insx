...
---@class minx.kit.Async.AsyncTask
---@field private value any
---@field private status minx.kit.Async.AsyncTask.Status
...
---@param task minx.kit.Async.AsyncTask
---@param status minx.kit.Async.AsyncTask.Status
---@param value any
...
---@enum minx.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: minx.kit.Async.AsyncTask.Status, value: any }
